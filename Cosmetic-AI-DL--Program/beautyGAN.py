...
os.path.join('C:/Users/SSAFY/Downloads', 'no_makeup', 'image.png'), help = 'path to the no_makeup image')
...
with tf.compat.v1.Session() as ses:
    ...
    saver = tf.train.import_meta_graph(os.path.join('C:/Users/SSAFY/Desktop/hi/Cosmetic-AI-DL--Program', 'model.meta'))
    saver.restore(ses, tf.train.latest_checkpoint('C:/Users/SSAFY/Desktop/hi/Cosmetic-AI-DL--Program'))
    ...
    imsave('C:/Users/SSAFY/Downloads/result.jpg', result)